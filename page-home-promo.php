		...
		<div class="inner-wrap">
			...
			<?php 
				...
				if ($now < $end) {
					...
					<div class="promo-box" style="background-color: #444; padding: 2em 0px">
						  <div class="row">
						  		<div class="large-9 columns">
							    	<h4 style="line-height: 1em; margin: 0; color: #FFF;">Sign a contract on a Botanical Heights home before June 15 and</h4><h3 style="color: #FFF;">save up to $14,000 on an upgrade option package.</h3>
								</div>
								<div class="large-3 columns">
									<a href="http://uicstl.com/june-upgrade-promo/" class="button">Get Started</a>
								</div>
						  </div>
					</div>
