...
define( 'CUSTOM_METABOXES_DIR', get_stylesheet_directory_uri() . '/library/classes/metaboxes' );
...
class Custom_Add_Meta_Box {
	...
	function save_box( $post_id ) {
		...
		foreach ( $this->fields as $field ) {
			...
			if( in_array( $field['type'], array( 'tax_apply', 'tax_checkboxes' ) ) ) {
				// save taxonomies
